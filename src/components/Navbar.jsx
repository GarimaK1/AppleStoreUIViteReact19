...
const Navbar = ({ activePage, handleNavClick, isNavbarOpen, toggleNavbar }) => {
  return (
    <>
      <div className={`2xl:w-80 xl:w-52 w-44 h-full bg-slate-50 
                    flex flex-col justify-between py-5 px-3 md:pb-0 absolute md:relative z-10 transition-transform duration-200
